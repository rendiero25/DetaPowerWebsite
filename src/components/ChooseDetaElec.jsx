...
const ChooseDetaElec = () => {
    return(
        <div 
            className="flex flex-col xl:flex-row justify-between items-center w-full h-[35rem] -mt-10">
                <div 
                ...
                <div className='w-1/2 h-full px-18 py-12 flex flex-col justify-center items-start gap-6 bg-primary'>
                    <h1 className='font-bold text-4xl xl:text-5xl text-white uppercase'>
                        Choose Deta Electric
                    </h1>

                    <p className='font-bold text-3xl text-white leading-normal max-w-lg'>Provide comprehensive and 
